# Browser Builds
Wwwcore and most official submodules work in the browser, thanks to [browserify](http://browserify.org/) (some modules are not fully compatible with web browsers).
...
<head>
  <meta charset="utf-8">
  <script src="bower_components/wwwcore/wwwcore-lib.min.js"></script>
...
```sh
browserify --require ./index.js:wwwcore-lib | uglifyjs > wwwcore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external wwwcore-lib | uglifyjs > bitcore-mnemonic.min.js
```
