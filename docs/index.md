...
* [Acknowledging and Requesting Payments: Wwwcore URIs](uri.md)
...
var imported = wwwcore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new wwwcore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new wwwcore.URI(paymentInfo).toString();
```
